 ...
 * la función main la tumba del Tamagotchi cuando este fallezca. Esta función
 * devuelve un String compuesto por el dibujo de una lápida, así como de las
 * variables "nombre", "raza" y "turnos" de la función principal. Además,
 * contamos con un switch y un random que, dependiendo del número que salga (del
 * 1 al 4, ya que el 5 no se incluye), hará que en la lápida aparezca una frase
 * u otra.
 * 
