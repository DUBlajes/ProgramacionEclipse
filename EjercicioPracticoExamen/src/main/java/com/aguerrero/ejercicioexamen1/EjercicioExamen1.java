package com.aguerrero.ejercicioexamen1;
...
public class EjercicioExamen1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Dime cuántos metros sin decimales eres capaz de correr haciendo el Naruto-Run sin parar:");
		...
		System.out.println("El presupuesto anual de estos 3 otakus para gastarse en salones del manga es de un total de "+presupuestoAcumulado/otakusIntroducidos+" euros.");
		float mediaKilometros=(float)((metrosAcumulados)/3f)/1000f;
		System.out.println("La media que estos tres otakus son capaces de aguantar corriendo a lo Naruto sin detenerse es de "+mediaKilometros+" kms. Para sorpresa de nadie, no es mucho.");
