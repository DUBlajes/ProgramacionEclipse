...
/**
 * Clase con funciones auxiliares para el ejemplo de usos de funciones. Tenemos varias funciones matemáticas como dos que generan aleatorios y una que comprueba si un número es primo. Se irán añadiendo más en el futuro.
 * @author Álvaro Guerrero
 * @author Perico el de los palotes
 * @version 4
 * @since o.3b
 * Funcion inicial de prueba que solo hace un sysout que dice hola
 */
...
/**
 * Función que devuelve dos número aleatorios entre el valor inferior y el valor límite. EL valor del límite itene que ser 127 como mucho. El valor siempre tiene que ser menor al del límite.
 * @param inferior Numero mínimo (incluido) que podría salir aleatoriamente
 * @param limite número máximo (no incluido) que saldrá alatoriamente. El mínimo posible es 0
